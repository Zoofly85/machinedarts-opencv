...
import { ArrowLeft, BarChart3, List, RefreshCw, Trash2 } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-6">
            <aside className="rounded-2xl border border-white/10 bg-black/40 p-5">
              ...
              <div className="mb-4 space-y-2" key={`create-${players.length}`}>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          disabled={isDeleting}
                          className="inline-flex items-center gap-1 rounded-lg border border-red-500/50 bg-red-500/10 px-2 py-1 text-xs font-semibold text-red-100 transition hover:bg-red-500/20 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <Trash2 size={14} />

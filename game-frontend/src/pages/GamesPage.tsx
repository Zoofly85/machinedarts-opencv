...
import { PlayCircle, Target, Grid, Beer, Code } from "lucide-react";
...
const games = [
  ...
  { name: "Beer Race", description: "Race to target score Aú Power scoring", game: "beer_race", icon: <Beer className="h-6 w-6" /> },
            ...
            {games.map((game) => (
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-4 relative z-10">
                  ...
                  <h2 className="text-xl font-bold group-hover:text-red-400 transition">
                    {game.name}
                  </h2>
                </div>
                <p className="text-zinc-400 relative z-10 text-sm sm:text-base">
                  {game.description}
                </p>
              </Link>
            ))}

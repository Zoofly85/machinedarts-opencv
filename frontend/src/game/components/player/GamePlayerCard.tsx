...
const GamePlayerCard = React.memo(
  ({
    ...
    return (
      <div
        className={`rounded-2xl border px-6 py-5 transition shadow-[0_12px_50px_rgba(0,0,0,0.35)] ${variantClassName[variant]} ${activeStateClassName}`}
      >
        ...
        <div className="mt-3 flex items-center justify-between gap-3">
          <div className={`min-w-0 ${mainClassName ?? ""}`}>{main}</div>

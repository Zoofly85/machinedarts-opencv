...
import { Activity, SlidersHorizontal, Cpu, ArrowLeft } from "lucide-react";
      ...
      <main className="relative z-10 w-full px-6 md:px-10 py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
          ...
          >
            ...
            <div className="text-sm text-zinc-400 mt-1">Track dart count, corrections, and system accuracy.</div>
          </Link>
          <Link

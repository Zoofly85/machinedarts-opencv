...
STABLE_END_FRAMES_FOR_DETECT = int(max(1, int(os.getenv("MACHINE_DARTS_STABLE_END_FRAMES_FOR_DETECT", "6"))))
BEST_DIFF_FRAMES = int(max(1, min(16, int(os.getenv("MACHINE_DARTS_BEST_DIFF_FRAMES", "8")))))
BEST_DIFF_WINDOW_MS = float(max(0.0, min(1000.0, float(os.getenv("MACHINE_DARTS_BEST_DIFF_WINDOW_MS", "280")))))

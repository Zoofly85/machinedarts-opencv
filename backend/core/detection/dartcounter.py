...
BEST_DIFF_FRAMES = int(max(1, min(16, int(os.getenv("MACHINE_DARTS_BEST_DIFF_FRAMES", "4")))))
BEST_DIFF_WINDOW_MS = float(max(0.0, min(1000.0, float(os.getenv("MACHINE_DARTS_BEST_DIFF_WINDOW_MS", "120")))))
